...
class Conf(arguments: Seq[String]) extends ScallopConf(arguments) {
  ...
  val stopAtNewHighScore: ScallopOption[Boolean] = toggle(default=Some(true), descrYes="default:stop a continuous play game if a new high score is reached", descrNo = "don't stop a continuous play game if a new high score is reached")
